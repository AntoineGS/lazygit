...
| `` mc `` | Continue rebase / merge | 現在のマージ/リベースを中止/継続/スキップするオプションを表示します。 |
| `` ma `` | Abort rebase / merge | 現在のマージ/リベースを中止/継続/スキップするオプションを表示します。 |
| `` ms `` | Skip current rebase commit | 現在のマージ/リベースを中止/継続/スキップするオプションを表示します。 |
...
| `` ff `` | フィックスアップ | 選択したコミットをその下のコミットにマージします。フィックスアップはスカッシュと似ていますが、選択したコミットのメッセージは破棄され、下のコミットのメッセージのみが保持されます。 |
...
| `` gm `` | Mixed reset | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされていない変更として保持します。変更内容を再ステージしたい場合に便利です。 |
| `` gs `` | ソフトリセット（変更を保持してステージ） | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされた変更として保持します。作業内容を保持したまま、コミット履歴を変更したい場合に便利です。 |
| `` gh `` | ハードリセット（すべての変更を破棄） | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間のすべての変更、および作業ツリー内の現在のすべての変更を破棄します。注意：このオプションでは変更が完全に削除されます。 |
...
| `` b `` | 一括サブモジュールオプションを表示 |  |
| `` bi `` | すべてのサブモジュールを一括初期化 |  |
| `` bu `` | すべてのサブモジュールを一括更新 |  |
| `` br `` | すべてのサブモジュールを再帰的に一括初期化および更新 |  |
| `` bd `` | すべてのサブモジュールを一括解除 |  |
| `` / `` | 現在のビューをテキストでフィルタリング |  |
...
| `` d `` | 削除 |  |
| `` dc `` | ローカルタグを削除 | ローカル/リモートタグの削除オプションを表示します。 |
| `` dr `` | リモートタグを削除 | ローカル/リモートタグの削除オプションを表示します。 |
| `` db `` | ローカルとリモートのタグを削除 | ローカル/リモートタグの削除オプションを表示します。 |
...
| `` <ctrl+b>s `` | ステージされたファイルのみ表示 |  |
| `` <ctrl+b>u `` | ステージされていないファイルのみ表示 |  |
| `` <ctrl+b>t `` | 追跡されているファイルのみ表示 |  |
| `` <ctrl+b>T `` | 追跡されていないファイルのみ表示 |  |
| `` <ctrl+b>r `` | フィルタなし |  |
| `` y `` | クリップボードにコピー |  |
| `` yn `` | ファイル名 |  |
| `` yp `` | 相対パス |  |
| `` yP `` | 絶対パス |  |
| `` ys `` | 選択したファイルの差分 | ステージされた項目がある場合、このコマンドはそれらのみを考慮します。そうでない場合は、ステージされていないすべての項目を考慮します。 |
| `` ya `` | すべてのファイルの差分 | ステージされた項目がある場合、このコマンドはそれらのみを考慮します。そうでない場合は、ステージされていないすべての項目を考慮します。 |
...
| `` Si `` | すべての変更をスタッシュしてインデックスを保持 |  |
| `` SU `` | 追跡されていないファイルを含むすべての変更をスタッシュ |  |
| `` Ss `` | ステージされた変更をスタッシュ |  |
| `` Su `` | ステージされていない変更をスタッシュ |  |
...
| `` d `` | Discard changes |  |
| `` dc `` | 破棄 | 選択したファイルの変更を破棄するオプションを表示します。 |
| `` du `` | ステージされていない変更を破棄 |  |
| `` g `` | Reset to upstream |  |
| `` gm `` | Mixed reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされていない変更として保持します。変更内容を再ステージしたい場合に便利です。 |
| `` gs `` | Soft reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされた変更として保持します。作業内容を保持したまま、コミット履歴を変更したい場合に便利です。 |
| `` gh `` | Hard reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間のすべての変更、および作業ツリー内の現在のすべての変更を破棄します。注意：このオプションでは変更が完全に削除されます。 |
| `` D `` | リセット | 作業ツリーのリセットオプション（例：作業ツリーの完全破棄）を表示します。 |
| `` Dx `` | 作業ツリーを完全に破棄 | 作業ツリー内のすべての変更を消したい場合は、これが方法です。サブモジュールに変更がある場合、それらの変更はサブモジュール内にスタッシュされます。 |
| `` Du `` | ステージされていない変更を破棄 |  |
| `` Dc `` | 追跡されていないファイルを破棄 |  |
| `` DS `` | ステージされた変更を破棄 | これはステージされたファイルのみを含む新しいスタッシュエントリを作成し、その後それを削除するため、作業ツリーにはステージされていない変更のみが残ります |
| `` Ds `` | ソフトリセット（変更を保持してステージ） |  |
| `` Dm `` | mixed reset |  |
| `` Dh `` | ハードリセット（すべての変更を破棄） |  |
| `` ` `` | ファイルツリービューを切り替え | ファイル表示をフラット表示とツリー表示で切り替えます。フラット表示はすべてのファイルパスを一覧で表示し、ツリー表示はディレクトリごとにファイルをグループ化します。<br><br>デフォルトは設定ファイル内の 'gui.showFileTree' キーで変更できます。 |
| `` <ctrl+t> `` | 外部差分ツールを開く（git difftool） |  |
...
| `` n `` | 新しいブランチ |  |
| `` M `` | Merge |  |
| `` Mm `` | マージ | 選択した項目を現在のブランチにマージするためのオプションを表示します（通常のマージ、スカッシュマージ） |
...
| `` r `` | Rebase options |  |
| `` rs `` | リベース | チェックアウトしたブランチを選択したブランチ上にリベースします。 |
| `` ri `` | Interactive rebase | 開始時に一時停止する対話的リベースを開始します。これにより、続行する前にTODOコミットを更新できます。 |
| `` rb `` | Rebase onto base branch | チェックアウトしたブランチをそのベースブランチ（つまり、最も近いメインブランチ）にリベースします。 |
| `` d `` | 削除 | リモートからリモートブランチを削除します。 |
| `` us `` | アップストリームとして設定 | 選択したリモートブランチをチェックアウトされたブランチのアップストリームとして設定します。 |
| `` s `` | 並び順 |  |
| `` g `` | Reset to ref |  |
| `` gm `` | Mixed reset | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされていない変更として保持します。変更内容を再ステージしたい場合に便利です。 |
| `` gs `` | ソフトリセット（変更を保持してステージ） | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされた変更として保持します。作業内容を保持したまま、コミット履歴を変更したい場合に便利です。 |
...
| `` dc `` | ローカルブランチを削除 | ローカル/リモートブランチの削除オプションを表示します。 |
| `` dr `` | リモートブランチを削除 | リモートからリモートブランチを削除します。 |
| `` db `` | ローカルとリモートのブランチを削除 | ローカル/リモートブランチの削除オプションを表示します。 |
| `` r `` | リベース | チェックアウトしたブランチを選択したブランチ上にリベースします。 |
| `` rs `` | Simple rebase | チェックアウトしたブランチを選択したブランチ上にリベースします。 |
| `` ri `` | Interactive rebase | 開始時に一時停止する対話的リベースを開始します。これにより、続行する前にTODOコミットを更新できます。 |
| `` rb `` | Rebase onto base branch | チェックアウトしたブランチをそのベースブランチ（つまり、最も近いメインブランチ）にリベースします。 |
...
| `` ud `` | アップストリームからの乖離を表示 | ブランチのアップストリームに関連するオプションを表示します（例：アップストリームの設定/解除やアップストリームへのリセット）。 |
| `` uD `` | View divergence from base branch |  |
| `` us `` | 選択したブランチのアップストリームを設定 |  |
| `` uu `` | 選択したブランチのアップストリームを解除 |  |
| `` ugm `` | Mixed reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされていない変更として保持します。変更内容を再ステージしたい場合に便利です。 |
| `` ugs `` | Soft reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間の変更をステージされた変更として保持します。作業内容を保持したまま、コミット履歴を変更したい場合に便利です。 |
| `` ugh `` | Hard reset to upstream | HEADを選択したコミットにリセットし、現在のコミットと選択したコミットとの間のすべての変更、および作業ツリー内の現在のすべての変更を破棄します。注意：このオプションでは変更が完全に削除されます。 |
| `` urs `` | Simple rebase onto upstream |  |
| `` uri `` | Interactive rebase onto upstream | 開始時に一時停止する対話的リベースを開始します。これにより、続行する前にTODOコミットを更新できます。 |
| `` urb `` | Rebase onto base branch | チェックアウトしたブランチをそのベースブランチ（つまり、最も近いメインブランチ）にリベースします。 |
| `` <ctrl+t> `` | 外部差分ツールを開く（git difftool） |  |
| `` 0 `` | メインビューにフォーカス |  |
| `` <enter> `` | コミットを表示 |  |
| `` w `` | ワークツリーオプションを表示 |  |
