...
var ChordStatusFilterPopup = NewIntegrationTest(NewIntegrationTestArgs{
	...
	Run: func(t *TestDriver, keys config.KeybindingConfig) {
		t.Views().Files().Focus().Press(keys.ChordPrefix.Get("files", config.ChordIDFilterFiles))
		...
		t.Views().Files().Press(keys.ChordPrefix.Get("files", config.ChordIDFilterFiles))
